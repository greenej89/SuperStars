      ...
      <form onSubmit={onSubmitHandler}>
        {/* { formType === 'create' &&
          <div className='mb-1 d-flex align-items-center justify-content-center' >
            ...
            <p className='text-danger'>{ errors.kidId && errors.kidId.message }</p>
          </div>
        } */}
        <div className='mb-1 d-flex align-items-center justify-content-center' >
        ...
        { formType === 'edit' &&
          <div className='mb-1 d-flex align-items-center justify-content-center'>
            <label className='col-sm-4 col-form-label-lg text-start' htmlFor='awardedStars'>Awarded Stars:</label>
